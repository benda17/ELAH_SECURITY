...
| Password reset | Simulated **request** on `/forgot-password` (no email, password unchanged) | **In** as a monitorable event (`password_reset`). Mailbox / actual password change **Out**. |
