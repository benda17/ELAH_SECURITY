...
Evidence date: **16 September 2026**. Phase 7 design approved by the founder **17 September 2026**. CS/CRM taxonomy: 16 labels v0.1 — [ELAH_CS_CRM_TAXONOMY.md](../Phase%2016%20-%20B2B%20SaaS%20CS%20CRM%20wedge/ELAH_CS_CRM_TAXONOMY.md). Not a 23rd banking label.
...
This pack maps all **23** Phase 7 Kanban cards.
...
| 8 | Create a three-layer intention visualization | `task-7-create-a-three-layer-intention-visualization` | **Approved; implementation in progress** | ELAH-P7-VIS-001 | [ELAH_GRAPH_VISUAL_OVERLAYS.md](./ELAH_GRAPH_VISUAL_OVERLAYS.md) §three-layers — points / trajectories / evidence. **Not** H/B/S internals |
| 9 | Display individual action points | `task-7-display-individual-action-points` | **Approved; implementation in progress** | ELAH-P7-VIS-001 | [ELAH_GRAPH_VISUAL_OVERLAYS.md](./ELAH_GRAPH_VISUAL_OVERLAYS.md) §points. Live CS/CRM: founder `/banking/crm`. Banking demo: `/banking/intent-matrix` |
| 10 | Display action trajectories | `task-7-display-action-trajectories` | **Approved; implementation in progress** | ELAH-P7-SEQ-001 | [ELAH_GRAPH_SEQUENCES.md](./ELAH_GRAPH_SEQUENCES.md) §trajectories |
| 11 | Display user-request-to-agent-action relationships | `task-7-display-user-request-to-agent-action-relationshi` | **Approved; implementation in progress** | ELAH-P7-SEQ-001 | [ELAH_GRAPH_SEQUENCES.md](./ELAH_GRAPH_SEQUENCES.md) §request-to-tool |
| 12 | Display deviations from expected behavior | `task-7-display-deviations-from-expected-behavior` | **Approved; implementation in progress** | ELAH-P7-SEQ-001 | [ELAH_GRAPH_SEQUENCES.md](./ELAH_GRAPH_SEQUENCES.md) §deviations |
| 13 | Display model evidence | `task-7-display-model-evidence` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §evidence |
| 14 | Display contributing factors | `task-7-display-contributing-factors` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §contributing |
| 15 | Display reason codes | `task-7-display-reason-codes` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §reason-codes |
| 16 | Display alternative interpretations | `task-7-display-alternative-interpretations` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §alternatives — structured fields only; no CoT ranking |
| 17 | Add an event explanation panel | `task-7-add-an-event-explanation-panel` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) |
| 18 | Add model-version information | `task-7-add-model-version-information` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §provenance |
| 19 | Add raw-event inspection for authorized users | `task-7-add-raw-event-inspection-for-authorized-users` | **Approved; implementation in progress** | ELAH-P7-PANEL-001 | [ELAH_EXPLANATION_PANEL.md](./ELAH_EXPLANATION_PANEL.md) §raw-event — founder/analyst only |
| 20 | Test whether explanations are understandable to banking analysts (**rewrite: CS/CRM analyst protocol**) | `task-7-test-whether-explanations-are-understandable-to-` | **Protocol approved; test outstanding** | ELAH-P7-FAITH-001 | [ELAH_FAITHFULNESS_AND_PRIVACY.md](./ELAH_FAITHFULNESS_AND_PRIVACY.md) §understandability — protocol/script only; **no fabricated interview notes** |
| 21 | Test whether explanations remain faithful to model behavior | `task-7-test-whether-explanations-remain-faithful-to-mod` | **Protocol approved; test outstanding** | ELAH-P7-FAITH-001 | [ELAH_FAITHFULNESS_AND_PRIVACY.md](./ELAH_FAITHFULNESS_AND_PRIVACY.md) §faithfulness — checklist vs reason codes / matched signals, not chain-of-thought |
| 22 | Avoid exposing private model reasoning or unsupported chain-of-thought | `task-7-avoid-exposing-private-model-reasoning-or-unsupp` | **Approved; implementation in progress** | ELAH-P7-FAITH-001 | [ELAH_FAITHFULNESS_AND_PRIVACY.md](./ELAH_FAITHFULNESS_AND_PRIVACY.md) §no-cot |
| 23 | Use concise evidence-based explanations instead | `task-7-use-concise-evidence-based-explanations-instead` | **Approved; implementation in progress** | ELAH-P7-FAITH-001 | [ELAH_FAITHFULNESS_AND_PRIVACY.md](./ELAH_FAITHFULNESS_AND_PRIVACY.md) §concise |
