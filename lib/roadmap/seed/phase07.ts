...
export const PHASE07_TASKS: Phase07TaskSpec[] = [
  ...
  spec({
    ...
    today: "Phase 7 guidance defines concise, PII-safe explanations and the founder panel uses short structured evidence copy. CRM snapshots do not yet carry a reproducible explanation summary or matched/weak/negative signal lists.",
    doThis: `Maintain ${PHASE7_DOC_DIR}/ELAH_FAITHFULNESS_AND_PRIVACY.md, add signal-backed summary data to the analyst path, and keep explanation copy concise and evidence-based.`,
    inn: `${PHASE7_DOC_DIR}/ELAH_FAITHFULNESS_AND_PRIVACY.md.`,
    successCriteria:
